...
test6.csv,xopJdHvbmJMEUSHEWAhQaVPZkw,,932f2af3dadfa42444100cf652b2f1e9
test6.csv,jCrMDrz,,72574de72ba3b8f67b5d1d6e318a7417
test6.csv,UWnvbNHe,,f5488322ea682d460929a5d9ed160434
test6.csv,DnBlMQVaSUqbj,,6613613187257926210c60a86846d07e
test6.csv,fihSPFOmSZYXpZpZmRLVF,,a6d7ec27716846088f073d7f77c7ddb3
test6.csv,BhzJmUt,,fc7447cf4d46077860f31ec64a58ccc9
test6.csv,ViZspgaGYWyYmxySGANYpmYoDRuMq,,46dcd7c5285101bad201dda61e1f6d66
test6.csv,oqQyQjYOtnvxkcFsGcTBXNAg,,11d6b248f8dfe571d61d9afba8d8fbcc
test6.csv,cLuhONLqvLKWWrtoRNjJlOT,,e98115a32ce8c34feff0f95204dce0b6`);
      } else {
      ...
      chai.request(app)
        ...
        .end((err, res) => {
          ...
          expect(res.body[0].lines[0]).to.deep.equal({
            text: 'plGDYpiNMeTnHxsZxqFzIzhVEGW',
            number: null,
            hex: '35422b3f39f7257fa70f2223e9b69b73'
          });
          done();
        });
    });
